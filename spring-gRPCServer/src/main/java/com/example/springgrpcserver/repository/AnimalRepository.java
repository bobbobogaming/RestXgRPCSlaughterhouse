...
public interface AnimalRepository extends JpaRepository<AnimalEntity, Long> {
		@Query(value = "select * from animal_entity where registration_no = "
				+ "(select animal_entity_registration_no from animal_part_entity where id = :animalPartId)",
		nativeQuery = true)	List<AnimalEntity> findAllFromAnimalPart(@Param("animalPartId") long animalPartId);
		...
		nativeQuery = true)	List<AnimalEntity> findAllFromTray(@Param("trayId") long trayId);
